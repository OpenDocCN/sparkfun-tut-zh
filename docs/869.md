...
几千年来，我们一直在测量东西，从那以后，我们用来测量的单位一直在演变。现在有几十个单位来描述物理量。例如，长度可以用英尺、米、英寻、链、秒差距、联、[等等](http://en.wikipedia.org/wiki/Unit_of_length)来度量。为了更好地交流测量结果，我们需要一个标准化的单位系统，每个科学家和测量人员都可以用它来分享他们的发现。这种标准化的体系被称为国际单位制，缩写为 **SI** 。
